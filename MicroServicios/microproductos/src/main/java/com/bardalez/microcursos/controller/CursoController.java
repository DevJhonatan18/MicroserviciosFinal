...
public class CursoController {
    ...
    public Optional<Curso> updateEmployee(@RequestBody Curso newProducto, @PathVariable String codigo)
    {
        ...
        if (optionalPro.isPresent()) {
            ...
            prod.setHorario(newProducto.getHorario());
    ...
    {
        Curso prod = new Curso(newProducto.getCodigo(), newProducto.getNombre(), newProducto.getInstitucion() , newProducto.getCapacidadAlumnos(), newProducto.getPrecio() ,newProducto.getDescripcion() , newProducto.getHorario());
